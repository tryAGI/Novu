...
namespace Novu
{
    ...
    public sealed partial class DigestStepResponseDto
    {
        ...
        public required global::Novu.DigestControlsMetadataResponseDto Controls { get; set; }

        /// <summary>
        /// Control values for the digest step
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("controlValues")]
        public global::Novu.DigestControlDto? ControlValues { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DigestStepResponseDto" /> class.
        /// </summary>
        /// <param name="controls">
        /// Controls metadata for the digest step
        /// </param>
        ...
        public DigestStepResponseDto(
            global::Novu.DigestControlsMetadataResponseDto controls,
            object variables,
            string stepId,
            string id,
            string name,
            ...
            global::Novu.DigestControlDto? controlValues,
