            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    var __value = global::Novu.EventsControllerTriggerBulkResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::Novu.EventsControllerTriggerBulkResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
