...
namespace Novu
{
    ...
    public sealed partial class ChatStepResponseDto
    {
        ...
        public required global::Novu.ChatControlsMetadataResponseDto Controls { get; set; }

        /// <summary>
        /// Control values for the chat step
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("controlValues")]
        public global::Novu.ChatControlDto? ControlValues { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatStepResponseDto" /> class.
        /// </summary>
        /// <param name="controls">
        /// Controls metadata for the chat step
        /// </param>
        ...
        public ChatStepResponseDto(
            global::Novu.ChatControlsMetadataResponseDto controls,
            object variables,
            string stepId,
            string id,
            string name,
            ...
            global::Novu.ChatControlDto? controlValues,
