...
namespace Novu
{
    public partial class TopicsClient
    {
        ...
        private static readonly global::Novu.AutoSDKServer[] s_TopicsControllerDeleteTopicServers = new global::Novu.AutoSDKServer[]
        ...
        partial void PrepareTopicsControllerDeleteTopicArguments(
            ...
            ref string topicKey);
        partial void PrepareTopicsControllerDeleteTopicRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string topicKey);
        partial void ProcessTopicsControllerDeleteTopicResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTopicsControllerDeleteTopicResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.TopicsControllerDeleteTopicResponse> TopicsControllerDeleteTopicAsync(
            string topicKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Novu.PathBuilder(
                                ...
                                servers: s_TopicsControllerDeleteTopicServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Novu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Novu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TopicsControllerDeleteTopic",
                                methodName: "TopicsControllerDeleteTopicAsync",
                                pathTemplate: "$\"/v2/topics/{topicKey}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTopicsControllerDeleteTopicResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Novu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTopicsControllerDeleteTopicResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Novu.TopicsControllerDeleteTopicResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Novu.TopicsControllerDeleteTopicResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
