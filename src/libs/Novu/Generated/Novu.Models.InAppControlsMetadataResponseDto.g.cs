...
namespace Novu
{
    ...
    public sealed partial class InAppControlsMetadataResponseDto
    {
        ...
        public required global::Novu.InAppControlDto Values { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InAppControlsMetadataResponseDto" /> class.
        /// </summary>
        /// <param name="values">
        /// Control values specific to In-App
        /// </param>
        ...
        public InAppControlsMetadataResponseDto(
            global::Novu.InAppControlDto values,
            object? dataSchema,
