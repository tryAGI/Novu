...
namespace Novu
{
    ...
    public sealed partial class HttpRequestStepResponseDto
    {
        ...
        public required global::Novu.HttpRequestControlsMetadataResponseDto Controls { get; set; }

        /// <summary>
        /// Control values for the HTTP request step
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("controlValues")]
        public global::Novu.HttpRequestControlDto? ControlValues { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HttpRequestStepResponseDto" /> class.
        /// </summary>
        /// <param name="controls">
        /// Controls metadata for the HTTP request step
        /// </param>
        ...
        public HttpRequestStepResponseDto(
            global::Novu.HttpRequestControlsMetadataResponseDto controls,
            object variables,
            string stepId,
            string id,
            string name,
            ...
            global::Novu.HttpRequestControlDto? controlValues,
