            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    var __value = global::Novu.WorkflowControllerGeneratePreviewResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::Novu.WorkflowControllerGeneratePreviewResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
