...
namespace Novu
{
    public partial interface ITopicsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.TopicsControllerListTopicSubscriptionsResponse>> TopicsControllerListTopicSubscriptionsAsResponseAsync(
            string topicKey,
            string? after = default,
            string? before = default,
            double? limit = default,
