...
namespace Novu
{
    ...
    public sealed partial class EmailStepResponseDto
    {
        ...
        public required global::Novu.EmailControlsMetadataResponseDto Controls { get; set; }

        /// <summary>
        /// Control values for the email step
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("controlValues")]
        public global::Novu.EmailControlDto? ControlValues { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailStepResponseDto" /> class.
        /// </summary>
        /// <param name="controls">
        /// Controls metadata for the email step
        /// </param>
        ...
        public EmailStepResponseDto(
            global::Novu.EmailControlsMetadataResponseDto controls,
            object variables,
            string stepId,
            string id,
            string name,
            ...
            global::Novu.EmailControlDto? controlValues,
