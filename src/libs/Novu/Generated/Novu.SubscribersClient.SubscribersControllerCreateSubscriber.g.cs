...
namespace Novu
{
    ...
    {
        partial void PrepareSubscribersControllerCreateSubscriberArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? failIfExists,
            global::Novu.CreateSubscriberRequestDto request);
        partial void PrepareSubscribersControllerCreateSubscriberRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? failIfExists,
            global::Novu.CreateSubscriberRequestDto request);
        partial void ProcessSubscribersControllerCreateSubscriberResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubscribersControllerCreateSubscriberResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.SubscribersControllerCreateSubscriberResponse> SubscribersControllerCreateSubscriberAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSubscribersControllerCreateSubscriberArguments(
            ...
            PrepareSubscribersControllerCreateSubscriberRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessSubscribersControllerCreateSubscriberResponse(
                httpClient: HttpClient,
            ...
            // Subscriber already exists (when query param failIfExists=true)
            if ((int)__response.StatusCode == 409)
            {
                string? __content_409 = null;
                global::System.Exception? __exception_409 = null;
                global::Novu.SubscriberResponseDto? __value_409 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_409 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_409 = global::Novu.SubscriberResponseDto.FromJson(__content_409, JsonSerializerContext);
                    }
                    else
                    {
                        __content_409 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Novu.ApiException<global::Novu.SubscriberResponseDto>(
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessSubscribersControllerCreateSubscriberResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    var __value = global::Novu.SubscribersControllerCreateSubscriberResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::Novu.SubscribersControllerCreateSubscriberResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await SubscribersControllerCreateSubscriberAsync(
                failIfExists: failIfExists,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
