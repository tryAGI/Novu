...
namespace Novu
{
    ...
    public sealed partial class StepResponseDto
    {
        ...
        public required global::Novu.ControlsMetadataDto Controls { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StepResponseDto" /> class.
        /// </summary>
        /// <param name="controls">
        /// Controls metadata for the step
        /// </param>
        ...
        public StepResponseDto(
            global::Novu.ControlsMetadataDto controls,
            object variables,
            string stepId,
            string id,
            string name,
