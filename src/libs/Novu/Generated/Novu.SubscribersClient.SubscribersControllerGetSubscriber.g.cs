            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    var __value = global::Novu.SubscribersControllerGetSubscriberResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::Novu.SubscribersControllerGetSubscriberResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
