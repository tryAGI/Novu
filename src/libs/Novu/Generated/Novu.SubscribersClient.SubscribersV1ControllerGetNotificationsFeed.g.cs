            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    var __value = global::Novu.SubscribersV1ControllerGetNotificationsFeedResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::Novu.SubscribersV1ControllerGetNotificationsFeedResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
