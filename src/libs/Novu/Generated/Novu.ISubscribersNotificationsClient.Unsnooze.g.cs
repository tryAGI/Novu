...
namespace Novu
{
    public partial interface ISubscribersNotificationsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Novu.InboxNotificationDto> UnsnoozeAsync(
            string subscriberId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.InboxNotificationDto>> UnsnoozeAsResponseAsync(
            string subscriberId,
            string notificationId,
            global::System.Collections.Generic.IList<string>? contextKeys = default,
            global::Novu.AutoSDKRequestOptions? requestOptions = default,
