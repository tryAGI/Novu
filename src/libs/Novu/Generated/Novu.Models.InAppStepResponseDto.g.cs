...
namespace Novu
{
    ...
    public sealed partial class InAppStepResponseDto
    {
        ...
        public required global::Novu.InAppControlsMetadataResponseDto Controls { get; set; }

        /// <summary>
        /// Control values for the in-app step
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("controlValues")]
        public global::Novu.InAppControlDto? ControlValues { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InAppStepResponseDto" /> class.
        /// </summary>
        /// <param name="controls">
        /// Controls metadata for the in-app step
        /// </param>
        ...
        public InAppStepResponseDto(
            global::Novu.InAppControlsMetadataResponseDto controls,
            object variables,
            string stepId,
            string id,
            string name,
            ...
            global::Novu.InAppControlDto? controlValues,
