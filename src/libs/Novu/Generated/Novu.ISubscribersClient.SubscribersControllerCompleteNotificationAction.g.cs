...
namespace Novu
{
    public partial interface ISubscribersClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.InboxNotificationDto>> SubscribersControllerCompleteNotificationActionAsResponseAsync(
            string subscriberId,
            string notificationId,
            global::Novu.SubscribersControllerCompleteNotificationActionActionType actionType,
            global::System.Collections.Generic.IList<string>? contextKeys = default,
