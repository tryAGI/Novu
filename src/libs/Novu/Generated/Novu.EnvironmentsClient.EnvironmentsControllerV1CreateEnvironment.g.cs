...
namespace Novu
{
    ...
    {
        partial void PrepareEnvironmentsControllerV1CreateEnvironmentArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Novu.CreateEnvironmentRequestDto request);
        partial void PrepareEnvironmentsControllerV1CreateEnvironmentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Novu.CreateEnvironmentRequestDto request);
        partial void ProcessEnvironmentsControllerV1CreateEnvironmentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEnvironmentsControllerV1CreateEnvironmentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.EnvironmentsControllerV1CreateEnvironmentResponse> EnvironmentsControllerV1CreateEnvironmentAsync(

            global::Novu.CreateEnvironmentRequestDto request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await EnvironmentsControllerV1CreateEnvironmentAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.EnvironmentsControllerV1CreateEnvironmentResponse>> EnvironmentsControllerV1CreateEnvironmentAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEnvironmentsControllerV1CreateEnvironmentArguments(
            ...
            PrepareEnvironmentsControllerV1CreateEnvironmentRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessEnvironmentsControllerV1CreateEnvironmentResponse(
                httpClient: HttpClient,
            ...
            if ((int)__response.StatusCode == 402)
            {
                ...
                global::Novu.ErrorDto? __value_402 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_402 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_402 = global::Novu.ErrorDto.FromJson(__content_402, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_402 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessEnvironmentsControllerV1CreateEnvironmentResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    var __value = global::Novu.EnvironmentsControllerV1CreateEnvironmentResponse.FromJson(__content, JsonSerializerOptions) ??
                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                    return new global::Novu.AutoSDKHttpResponse<global::Novu.EnvironmentsControllerV1CreateEnvironmentResponse>(
                        statusCode: __response.StatusCode,
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::Novu.EnvironmentsControllerV1CreateEnvironmentResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await EnvironmentsControllerV1CreateEnvironmentAsync(
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
