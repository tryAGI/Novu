...
namespace Novu
{
    public partial class IntegrationsClient
    {
        ...
        private static readonly global::Novu.AutoSDKServer[] s_LinkChannelEndpointServers = new global::Novu.AutoSDKServer[]
        ...
        private static readonly global::Novu.EndPointSecurityRequirement s_LinkChannelEndpointSecurityRequirement0 =
        ...
        private static readonly global::Novu.EndPointSecurityRequirement[] s_LinkChannelEndpointSecurityRequirements =
            new global::Novu.EndPointSecurityRequirement[]
            {                s_LinkChannelEndpointSecurityRequirement0,
            };
        partial void PrepareLinkChannelEndpointArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Novu.LinkChannelEndpointRequestDto request);
        partial void PrepareLinkChannelEndpointRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Novu.LinkChannelEndpointRequestDto request);
        partial void ProcessLinkChannelEndpointResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessLinkChannelEndpointResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.IntegrationsControllerLinkChannelEndpointResponse> LinkChannelEndpointAsync(

            global::Novu.LinkChannelEndpointRequestDto request,
            global::Novu.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await LinkChannelEndpointAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.IntegrationsControllerLinkChannelEndpointResponse>> LinkChannelEndpointAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareLinkChannelEndpointArguments(
            ...
            var __authorizations = global::Novu.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_LinkChannelEndpointSecurityRequirements,
                operationName: "LinkChannelEndpointAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Novu.PathBuilder(
                                ...
                                servers: s_LinkChannelEndpointServers,
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareLinkChannelEndpointRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Novu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Novu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "LinkChannelEndpoint",
                                methodName: "LinkChannelEndpointAsync",
                                pathTemplate: "\"/v1/integrations/channel-endpoints/link\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessLinkChannelEndpointResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Novu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessLinkChannelEndpointResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Novu.IntegrationsControllerLinkChannelEndpointResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Novu.AutoSDKHttpResponse<global::Novu.IntegrationsControllerLinkChannelEndpointResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Novu.IntegrationsControllerLinkChannelEndpointResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.IntegrationsControllerLinkChannelEndpointResponse> LinkChannelEndpointAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Novu.LinkChannelEndpointRequestDto
            {
            ...
            return await LinkChannelEndpointAsync(
                request: __request,
                requestOptions: requestOptions,
