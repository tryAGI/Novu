...
namespace Novu
{
    public partial class EventsClient
    {
        ...
        private static readonly global::Novu.AutoSDKServer[] s_TriggerBroadcastServers = new global::Novu.AutoSDKServer[]
        ...
        private static readonly global::Novu.EndPointSecurityRequirement s_TriggerBroadcastSecurityRequirement0 =
        ...
        private static readonly global::Novu.EndPointSecurityRequirement[] s_TriggerBroadcastSecurityRequirements =
            new global::Novu.EndPointSecurityRequirement[]
            {                s_TriggerBroadcastSecurityRequirement0,
            };
        partial void PrepareTriggerBroadcastArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Novu.TriggerEventToAllRequestDto request);
        partial void PrepareTriggerBroadcastRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Novu.TriggerEventToAllRequestDto request);
        partial void ProcessTriggerBroadcastResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTriggerBroadcastResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.EventsControllerBroadcastEventToAllResponse> TriggerBroadcastAsync(

            global::Novu.TriggerEventToAllRequestDto request,
            global::Novu.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await TriggerBroadcastAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.EventsControllerBroadcastEventToAllResponse>> TriggerBroadcastAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTriggerBroadcastArguments(
            ...
            var __authorizations = global::Novu.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TriggerBroadcastSecurityRequirements,
                operationName: "TriggerBroadcastAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Novu.PathBuilder(
                                ...
                                servers: s_TriggerBroadcastServers,
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTriggerBroadcastRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Novu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Novu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "TriggerBroadcastAsync",
                                pathTemplate: "\"/v1/events/trigger/broadcast\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTriggerBroadcastResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Novu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        ...
                                        __value_400 = global::Novu.PayloadValidationExceptionDto.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Novu.ApiException<global::Novu.PayloadValidationExceptionDto>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTriggerBroadcastResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Novu.EventsControllerBroadcastEventToAllResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Novu.EventsControllerBroadcastEventToAllResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.EventsControllerBroadcastEventToAllResponse> TriggerBroadcastAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Novu.TriggerEventToAllRequestDto
            {
                Name = name,
                Payload = payload,
                Overrides = overrides,
            ...
            return await TriggerBroadcastAsync(
                request: __request,
                requestOptions: requestOptions,
