...
namespace Novu
{
    public partial class WorkflowsClient
    {
        ...
        private static readonly global::Novu.AutoSDKServer[] s_WorkflowControllerUpdateServers = new global::Novu.AutoSDKServer[]
        ...
        private static readonly global::Novu.EndPointSecurityRequirement s_WorkflowControllerUpdateSecurityRequirement0 =
        ...
        private static readonly global::Novu.EndPointSecurityRequirement[] s_WorkflowControllerUpdateSecurityRequirements =
            new global::Novu.EndPointSecurityRequirement[]
            {                s_WorkflowControllerUpdateSecurityRequirement0,
            };
        partial void PrepareWorkflowControllerUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string workflowId,
            global::Novu.UpdateWorkflowDto request);
        partial void PrepareWorkflowControllerUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string workflowId,
            global::Novu.UpdateWorkflowDto request);
        partial void ProcessWorkflowControllerUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWorkflowControllerUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.WorkflowControllerUpdateResponse> WorkflowControllerUpdateAsync(
            string workflowId,
        ...
        {
            var __response = await WorkflowControllerUpdateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.WorkflowControllerUpdateResponse>> WorkflowControllerUpdateAsResponseAsync(
            string workflowId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareWorkflowControllerUpdateArguments(
            ...
            var __authorizations = global::Novu.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WorkflowControllerUpdateSecurityRequirements,
                operationName: "WorkflowControllerUpdateAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Novu.PathBuilder(
                                ...
                                servers: s_WorkflowControllerUpdateServers,
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWorkflowControllerUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Novu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Novu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WorkflowControllerUpdate",
                                methodName: "WorkflowControllerUpdateAsync",
                                pathTemplate: "$\"/v2/workflows/{workflowId}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWorkflowControllerUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Novu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWorkflowControllerUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Novu.WorkflowControllerUpdateResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Novu.AutoSDKHttpResponse<global::Novu.WorkflowControllerUpdateResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Novu.WorkflowControllerUpdateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await WorkflowControllerUpdateAsync(
                workflowId: workflowId,
                request: __request,
                requestOptions: requestOptions,
