...
namespace Novu
{
    ...
    public sealed partial class DelayStepResponseDto
    {
        ...
        public required global::Novu.DelayControlsMetadataResponseDto Controls { get; set; }

        /// <summary>
        /// Control values for the delay step
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("controlValues")]
        public global::Novu.DelayControlDto? ControlValues { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DelayStepResponseDto" /> class.
        /// </summary>
        /// <param name="controls">
        /// Controls metadata for the delay step
        /// </param>
        ...
        public DelayStepResponseDto(
            global::Novu.DelayControlsMetadataResponseDto controls,
            object variables,
            string stepId,
            string id,
            string name,
            ...
            global::Novu.DelayControlDto? controlValues,
