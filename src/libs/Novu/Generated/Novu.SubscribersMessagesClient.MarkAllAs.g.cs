...
namespace Novu
{
    public partial class SubscribersMessagesClient
    {

        private static readonly global::Novu.AutoSDKServer[] s_MarkAllAsServers = new global::Novu.AutoSDKServer[]
        ...
        private static readonly global::Novu.EndPointSecurityRequirement s_MarkAllAsSecurityRequirement0 =
        ...
        private static readonly global::Novu.EndPointSecurityRequirement[] s_MarkAllAsSecurityRequirements =
            new global::Novu.EndPointSecurityRequirement[]
            {                s_MarkAllAsSecurityRequirement0,
            };
        partial void PrepareMarkAllAsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string subscriberId,
            global::Novu.MessageMarkAsRequestDto request);
        partial void PrepareMarkAllAsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string subscriberId,
            global::Novu.MessageMarkAsRequestDto request);
        partial void ProcessMarkAllAsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMarkAllAsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.SubscribersV1ControllerMarkMessagesAsResponse> MarkAllAsAsync(
            string subscriberId,
        ...
        {
            var __response = await MarkAllAsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.SubscribersV1ControllerMarkMessagesAsResponse>> MarkAllAsAsResponseAsync(
            string subscriberId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Novu.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_MarkAllAsSecurityRequirements,
                operationName: "MarkAllAsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Novu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Novu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "MarkAllAs",
                                methodName: "MarkAllAsAsync",
                                pathTemplate: "$\"/v1/subscribers/{subscriberId}/messages/mark-as\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Novu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMarkAllAsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Novu.SubscribersV1ControllerMarkMessagesAsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Novu.AutoSDKHttpResponse<global::Novu.SubscribersV1ControllerMarkMessagesAsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Novu.SubscribersV1ControllerMarkMessagesAsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
