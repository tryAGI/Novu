...
namespace Novu
{
    public partial interface ISubscribersMessagesClient
    {
        ...
        global::System.Threading.Tasks.Task<double> MarkAllAsync(
            string subscriberId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<double>> MarkAllAsResponseAsync(
            string subscriberId,
