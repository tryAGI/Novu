...
namespace Novu
{
    public partial class NotificationsClient
    {
        ...
        private static readonly global::Novu.AutoSDKServer[] s_NotificationsControllerListNotificationsServers = new global::Novu.AutoSDKServer[]
        ...
        partial void PrepareNotificationsControllerListNotificationsArguments(
            ...
            global::System.Collections.Generic.IList<string>? templates,
            global::System.Collections.Generic.IList<string>? emails,
            ref string? search,
            global::System.Collections.Generic.IList<string>? subscriberIds,
            global::System.Collections.Generic.IList<string>? severity,
            ref double? page,
            ref double? limit,
            ...
            ref string? after,
            ref string? before);
        partial void PrepareNotificationsControllerListNotificationsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after,
            string? before);
        partial void ProcessNotificationsControllerListNotificationsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessNotificationsControllerListNotificationsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.ActivitiesResponseDto> NotificationsControllerListNotificationsAsync(
        ...
        {
            var __response = await NotificationsControllerListNotificationsAsResponseAsync(
                channels: channels,
                templates: templates,
                emails: emails,
                search: search,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.ActivitiesResponseDto>> NotificationsControllerListNotificationsAsResponseAsync(
            global::System.Collections.Generic.IList<global::Novu.ChannelTypeEnum>? channels = default,
            global::System.Collections.Generic.IList<string>? templates = default,
            global::System.Collections.Generic.IList<string>? emails = default,
            string? search = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareNotificationsControllerListNotificationsArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Novu.PathBuilder(
                                ...
                                servers: s_NotificationsControllerListNotificationsServers,
                                defaultBaseUrl: "https://api.novu.co/"));
                            __pathBuilder
                                .AddOptionalParameter("channels", channels, selector: static x => x.ToValueString(), delimiter: ",", explode: true)
                                .AddOptionalParameter("templates", templates, delimiter: ",", explode: true)
                                .AddOptionalParameter("emails", emails, delimiter: ",", explode: true)
                                .AddOptionalParameter("search", search)
                                .AddOptionalParameter("subscriberIds", subscriberIds, delimiter: ",", explode: true)
                                .AddOptionalParameter("severity", severity, delimiter: ",", explode: true)
                                .AddOptionalParameter("page", page?.ToString())
                                .AddOptionalParameter("limit", limit?.ToString())
                                .AddOptionalParameter("transactionId", transactionId)
                                .AddOptionalParameter("topicKey", topicKey)
                                .AddOptionalParameter("subscriptionId", subscriptionId)
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareNotificationsControllerListNotificationsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Novu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Novu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "NotificationsControllerListNotifications",
                                methodName: "NotificationsControllerListNotificationsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessNotificationsControllerListNotificationsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Novu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessNotificationsControllerListNotificationsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Novu.ActivitiesResponseDto.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Novu.AutoSDKHttpResponse<global::Novu.ActivitiesResponseDto>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Novu.ActivitiesResponseDto.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
