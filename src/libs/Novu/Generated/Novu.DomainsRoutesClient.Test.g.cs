...
namespace Novu
{
    public partial class DomainsRoutesClient
    {
        ...
        private static readonly global::Novu.AutoSDKServer[] s_TestServers = new global::Novu.AutoSDKServer[]
        ...
        private static readonly global::Novu.EndPointSecurityRequirement s_TestSecurityRequirement0 =
        ...
        private static readonly global::Novu.EndPointSecurityRequirement[] s_TestSecurityRequirements =
            new global::Novu.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.DomainsControllerTestDomainRouteResponse> TestAsync(
            string domain,
            string address,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.DomainsControllerTestDomainRouteResponse>> TestAsResponseAsync(
            string domain,
            string address,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Novu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Novu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/v1/domains/{domain}/routes/{address}/test\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Novu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Novu.DomainsControllerTestDomainRouteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Novu.AutoSDKHttpResponse<global::Novu.DomainsControllerTestDomainRouteResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Novu.DomainsControllerTestDomainRouteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.DomainsControllerTestDomainRouteResponse> TestAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Novu.TestDomainRouteDto
            {
                From = from,
                Subject = subject,
                Text = text,
