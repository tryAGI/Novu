...
namespace Novu
{
    public partial class IntegrationsClient
    {
        ...
        private static readonly global::Novu.AutoSDKServer[] s_GenerateLinkUserOAuthUrlServers = new global::Novu.AutoSDKServer[]
        ...
        private static readonly global::Novu.EndPointSecurityRequirement s_GenerateLinkUserOAuthUrlSecurityRequirement0 =
        ...
        private static readonly global::Novu.EndPointSecurityRequirement[] s_GenerateLinkUserOAuthUrlSecurityRequirements =
            new global::Novu.EndPointSecurityRequirement[]
            {                s_GenerateLinkUserOAuthUrlSecurityRequirement0,
            };
        partial void PrepareGenerateLinkUserOAuthUrlArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Novu.GenerateLinkUserOauthUrlRequestDto request);
        partial void PrepareGenerateLinkUserOAuthUrlRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Novu.GenerateLinkUserOauthUrlRequestDto request);
        partial void ProcessGenerateLinkUserOAuthUrlResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateLinkUserOAuthUrlResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.IntegrationsControllerGenerateLinkUserOAuthUrlResponse> GenerateLinkUserOAuthUrlAsync(

            global::Novu.GenerateLinkUserOauthUrlRequestDto request,
            global::Novu.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateLinkUserOAuthUrlAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.IntegrationsControllerGenerateLinkUserOAuthUrlResponse>> GenerateLinkUserOAuthUrlAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateLinkUserOAuthUrlArguments(
            ...
            var __authorizations = global::Novu.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateLinkUserOAuthUrlSecurityRequirements,
                operationName: "GenerateLinkUserOAuthUrlAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Novu.PathBuilder(
                                ...
                                servers: s_GenerateLinkUserOAuthUrlServers,
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateLinkUserOAuthUrlRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Novu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Novu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateLinkUserOAuthUrl",
                                methodName: "GenerateLinkUserOAuthUrlAsync",
                                pathTemplate: "\"/v1/integrations/channel-endpoints/oauth\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateLinkUserOAuthUrlResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Novu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateLinkUserOAuthUrlResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Novu.IntegrationsControllerGenerateLinkUserOAuthUrlResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Novu.AutoSDKHttpResponse<global::Novu.IntegrationsControllerGenerateLinkUserOAuthUrlResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Novu.IntegrationsControllerGenerateLinkUserOAuthUrlResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.IntegrationsControllerGenerateLinkUserOAuthUrlResponse> GenerateLinkUserOAuthUrlAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Novu.GenerateLinkUserOauthUrlRequestDto
            {
            ...
            return await GenerateLinkUserOAuthUrlAsync(
                request: __request,
                requestOptions: requestOptions,
