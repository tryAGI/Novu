...
namespace Novu
{
    ...
    {
        partial void PrepareTopicsControllerUpsertTopicArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? failIfExists,
            global::Novu.CreateUpdateTopicRequestDto request);
        partial void PrepareTopicsControllerUpsertTopicRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? failIfExists,
            global::Novu.CreateUpdateTopicRequestDto request);
        partial void ProcessTopicsControllerUpsertTopicResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTopicsControllerUpsertTopicResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.TopicsControllerUpsertTopicResponse> TopicsControllerUpsertTopicAsync(

            global::Novu.CreateUpdateTopicRequestDto request,
            bool? failIfExists = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await TopicsControllerUpsertTopicAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.TopicsControllerUpsertTopicResponse>> TopicsControllerUpsertTopicAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTopicsControllerUpsertTopicArguments(
            ...
            PrepareTopicsControllerUpsertTopicRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessTopicsControllerUpsertTopicResponse(
                httpClient: HttpClient,
            ...
            // Topic already exists (when query param failIfExists=true)
            if ((int)__response.StatusCode == 409)
            {
                string? __content_409 = null;
                global::System.Exception? __exception_409 = null;
                global::Novu.TopicResponseDto? __value_409 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_409 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_409 = global::Novu.TopicResponseDto.FromJson(__content_409, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_409 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Novu.ApiException<global::Novu.TopicResponseDto>(
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessTopicsControllerUpsertTopicResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    var __value = global::Novu.TopicsControllerUpsertTopicResponse.FromJson(__content, JsonSerializerOptions) ??
                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                    return new global::Novu.AutoSDKHttpResponse<global::Novu.TopicsControllerUpsertTopicResponse>(
                        statusCode: __response.StatusCode,
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::Novu.TopicsControllerUpsertTopicResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.TopicsControllerUpsertTopicResponse> TopicsControllerUpsertTopicAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Novu.CreateUpdateTopicRequestDto
            {
                Key = key,
                Name = name,
            };

            return await TopicsControllerUpsertTopicAsync(
                failIfExists: failIfExists,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
