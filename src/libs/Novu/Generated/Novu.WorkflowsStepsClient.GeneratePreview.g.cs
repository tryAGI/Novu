...
namespace Novu
{
    public partial class WorkflowsStepsClient
    {
        ...
        private static readonly global::Novu.AutoSDKServer[] s_GeneratePreviewServers = new global::Novu.AutoSDKServer[]
        ...
        partial void PrepareGeneratePreviewRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string workflowId,
            string stepId,
            global::Novu.GeneratePreviewRequestDto request);
        partial void ProcessGeneratePreviewResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGeneratePreviewResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.WorkflowControllerGeneratePreviewResponse> GeneratePreviewAsync(
            string workflowId,
            string stepId,
        ...
        {
            var __response = await GeneratePreviewAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.WorkflowControllerGeneratePreviewResponse>> GeneratePreviewAsResponseAsync(
            string workflowId,
            string stepId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGeneratePreviewArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Novu.PathBuilder(
                                ...
                                servers: s_GeneratePreviewServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Novu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Novu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GeneratePreviewAsync",
                                pathTemplate: "$\"/v2/workflows/{workflowId}/step/{stepId}/preview\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGeneratePreviewResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Novu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGeneratePreviewResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Novu.WorkflowControllerGeneratePreviewResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Novu.AutoSDKHttpResponse<global::Novu.WorkflowControllerGeneratePreviewResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Novu.WorkflowControllerGeneratePreviewResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GeneratePreviewAsync(
                workflowId: workflowId,
                stepId: stepId,
                request: __request,
                requestOptions: requestOptions,
