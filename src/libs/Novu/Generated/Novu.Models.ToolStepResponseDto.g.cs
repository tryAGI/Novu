...
namespace Novu
{
    ...
    public sealed partial class ToolStepResponseDto
    {
        ...
        public required global::Novu.ToolControlsMetadataResponseDto Controls { get; set; }

        /// <summary>
        /// Control values for the tool step
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("controlValues")]
        public global::Novu.ToolControlDto? ControlValues { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolStepResponseDto" /> class.
        /// </summary>
        /// <param name="controls">
        /// Controls metadata for the tool step
        /// </param>
        ...
        public ToolStepResponseDto(
            global::Novu.ToolControlsMetadataResponseDto controls,
            object variables,
            string stepId,
            string id,
            string name,
            ...
            global::Novu.ToolControlDto? controlValues,
