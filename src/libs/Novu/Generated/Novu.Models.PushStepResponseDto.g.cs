...
namespace Novu
{
    ...
    public sealed partial class PushStepResponseDto
    {
        ...
        public required global::Novu.PushControlsMetadataResponseDto Controls { get; set; }

        /// <summary>
        /// Control values for the push step
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("controlValues")]
        public global::Novu.PushControlDto? ControlValues { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PushStepResponseDto" /> class.
        /// </summary>
        /// <param name="controls">
        /// Controls metadata for the push step
        /// </param>
        ...
        public PushStepResponseDto(
            global::Novu.PushControlsMetadataResponseDto controls,
            object variables,
            string stepId,
            string id,
            string name,
            ...
            global::Novu.PushControlDto? controlValues,
