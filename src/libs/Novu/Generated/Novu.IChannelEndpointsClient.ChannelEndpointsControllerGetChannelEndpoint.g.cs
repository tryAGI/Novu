...
namespace Novu
{
    public partial interface IChannelEndpointsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.ChannelEndpointsControllerGetChannelEndpointResponse>> ChannelEndpointsControllerGetChannelEndpointAsResponseAsync(
            string identifier,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
}