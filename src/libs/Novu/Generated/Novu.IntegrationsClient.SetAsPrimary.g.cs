...
namespace Novu
{
    public partial class IntegrationsClient
    {
        ...
        private static readonly global::Novu.AutoSDKServer[] s_SetAsPrimaryServers = new global::Novu.AutoSDKServer[]
        ...
        private static readonly global::Novu.EndPointSecurityRequirement s_SetAsPrimarySecurityRequirement0 =
        ...
        private static readonly global::Novu.EndPointSecurityRequirement[] s_SetAsPrimarySecurityRequirements =
            new global::Novu.EndPointSecurityRequirement[]
            {                s_SetAsPrimarySecurityRequirement0,
            };
        partial void PrepareSetAsPrimaryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string integrationId);
        partial void PrepareSetAsPrimaryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string integrationId);
        partial void ProcessSetAsPrimaryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSetAsPrimaryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Novu.IntegrationsControllerSetIntegrationAsPrimaryResponse> SetAsPrimaryAsync(
            string integrationId,
            global::Novu.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SetAsPrimaryAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Novu.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Novu.AutoSDKHttpResponse<global::Novu.IntegrationsControllerSetIntegrationAsPrimaryResponse>> SetAsPrimaryAsResponseAsync(
            string integrationId,
            global::Novu.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Novu.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SetAsPrimarySecurityRequirements,
                operationName: "SetAsPrimaryAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Novu.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Novu.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SetAsPrimaryAsync",
                                pathTemplate: "$\"/v1/integrations/{integrationId}/set-primary\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Novu.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSetAsPrimaryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Novu.IntegrationsControllerSetIntegrationAsPrimaryResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Novu.IntegrationsControllerSetIntegrationAsPrimaryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
