...
namespace Novu
{
    ...
    public sealed partial class ThrottleControlsMetadataResponseDto
    {
        ...
        public required global::Novu.ThrottleControlDto Values { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ThrottleControlsMetadataResponseDto" /> class.
        /// </summary>
        /// <param name="values">
        /// Control values specific to Throttle
        /// </param>
        ...
        public ThrottleControlsMetadataResponseDto(
            global::Novu.ThrottleControlDto values,
            object? dataSchema,
